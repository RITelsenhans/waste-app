...
export default function AdminPage() {
  ...
  useEffect(() => {
    void request<Case[]>("/v1/admin/cases?tenantId=demo")
      .then(setCases)
    ...
    <main>
      ...
      <section>
        ...
        <nav>
          ...
          <a href="#abc">Abfall-ABC</a>
          <a href="#orte">Standorte</a>
        ...
        <form className="waste-card waste-card--raised" id="termine" onSubmit={collection}>
          ...
          <label>
            ...
            <select name="addressId" required>
              <option value="demo-musterstrasse-12">Musterstraße 12</option>
              <option value="demo-parkweg-7">Parkweg 7</option>
              <option value="demo-ringstrasse-24">Ringstraße 24</option>
            </select>
          </label>
          <label>
            Abfallart-ID
      ...
      <section id="vorgaenge">
        <div className="section-head">
          <div>
            ...
            <h2>Reklamationen und Aufträge</h2>
          </div>
